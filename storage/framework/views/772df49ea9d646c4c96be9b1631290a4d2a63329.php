        ...
        <div class="n-container">
            <div class="mpd100 min-height500">
                ...
                <div class="mt25" id="question_msg">
                    <p class="sp merror"></p>
                    <p class="text-center mred mft16">订单已经生成，请勿重复提交订单</p>
                    <div class="text-center mt20">
                        <a href="<?php echo e(route('order_request')); ?>" class="mbtn-l mbtn-cyan-bd">正在自动跳转到上一页，如没有跳转请点击此链接</a>
                    </div>
                </div>
                <!--设置成功公用代码 end-->
...
//        var jumpTo = document.getElementById('jumpTo');
    ...
    countDown(3,'<?php echo e(route('order_request')); ?>');
