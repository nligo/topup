...
<head>
    ...
    <link rel="stylesheet" href="{{asset("Frontend/lib/spinner/")}}/jquery.spinner.css"/>
...
<script type="text/javascript" src="{{asset("Frontend/lib/spinner/")}}/jquery.spinner.js"></script>
